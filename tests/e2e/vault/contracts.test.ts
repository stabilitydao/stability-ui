...
// import { getAsset, seeds } from "@stabilitydao/stability";
...
//     const strategyInfo = getStrategyInfo(currentVault?.symbol);

//     const assets = strategyAssets.map((strategyAsset: string) => {
//       const token = getTokenData(strategyAsset);
//       if (token) {
//         const tokenExtended = getAsset(currentChain, token.address);
...
//     const isALM =
//       currentVault?.alm &&
//       ["Ichi", "DefiEdge", "Gamma"].includes(currentVault.alm.protocol);

//     const isUnderlying = currentVault.strategy === "Yearn";

//     let underlyingToken = {};

//     if (isALM || isUnderlying) {
//       const logo = getProtocolLogo(currentVault.strategyShortId);

//       underlyingToken = { symbol: currentVault.underlyingSymbol, logo: logo };
//     }
...
//           type: "Vault",
//           address: currentVault?.address.toLowerCase(),
//           isCopy: false,
//         },
//         {
//           logo: "/logo.svg",
//           symbol: currentVault.strategyShortId,
//           type: "Strategy",
//           address: currentVault?.strategy?.toLowerCase(),
//           isCopy: false,
//         },
//       ];
...
//           address: currentVault?.underlying,
//           isCopy: false,
//         });
//       }
//       if (currentVault?.pool?.address) {
//         const poolSymbol =
//           assets.length > 1
...
//           symbol: poolSymbol,
//           type: "Pool",
//           address: currentVault?.pool?.address,
//           isCopy: false,
//         });
//       }
//       if (assets) {
...
//           logo =
//             `https://api.stabilitydao.org/vault/${currentChain}/${currentVault.address}/logo.svg`.toLowerCase();
//         }
