      ...
      <div className="p-4">
        ...
        {!!holdData && (
          <div className="flex md:items-center gap-2">
            <div className="flex items-start mt-5 gap-5 md:gap-10 flex-col md:flex-row">
              {holdData.map((aprsData: IHoldData) => (
                <div key={aprsData.latestAPR}>
                  <p className="uppercase text-[13px] leading-3 text-[#8D8E96]">
                    VAULT VS {aprsData?.symbol} HOLD / ANNUAL
                  </p>
                  <div
            ...
            <div className="tooltip md:mt-[-6px] mt-[20px]">
              <svg
