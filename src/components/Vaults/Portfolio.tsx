          ...
          <div className="flex items-center gap-2">
            ...
            <div className="tooltip">
              <svg
                ...
                viewBox="0 0 16 16"
                fill="none"
                className="mt-[2px] ml-1 cursor-pointer opacity-40 hover:opacity-100 transition delay-[40ms] tooltip"
                onClick={(e) => {
                  e.stopPropagation();
                  setFeeAPRModal(true);
                }}
              ...
              <div className="visible__tooltip toBottom">
                <div className="flex items-start flex-col">
                  <p className="text-[14px] flex flex-col gap-1 w-full">
                    During times of high volatility, the majority of pool swap
                    fees may be used to cover Impermanent Losses (IL) once ALMs
                    rebalance positions. Excluding swap fees income from
                    profitability calculations can sometimes show more realistic
                    APRs.
                  </p>
                </div>
                <i></i>
