                            ...
                            >
                              ...
                              {upgrade?.proxy && (
                                <td className="text-right min-w-[150px]">
                                  <ShortAddress
                                    address={upgrade.proxy as TAddress}
                                  />
                                </td>
                              )}
                              {upgrade.oldImplementation && (
                                <td className="text-right min-w-[150px]">
                                  <ShortAddress
                                    address={
                                      upgrade?.oldImplementation as TAddress
                                    }
                                  />
                                </td>
                              )}
                              {upgrade?.newImplementation && (
                                <td className="text-right min-w-[150px]">
                                  <ShortAddress
                                    address={
                                      upgrade.newImplementation as TAddress
                                    }
                                  />
                                </td>
                              )}
                              ...
                              <div className="hidden md:flex gap-2 items-center">
                                ...
                                {vault?.risk?.isRektStrategy ? (
                                  <div
                                    ...
                                    title={
                                      vault?.risk?.isRektStrategy as string
                                    }
                                  ></div>
                                ) : (
