...
import type { PlatformData, UserBalance, VaultsData } from "../types";
...
//Vaults list
export const vaultData = atom<VaultsData | undefined>(undefined);
export function addVaultData(data: VaultsData) {
	vaultData.set(data);
}
//Vaults list
