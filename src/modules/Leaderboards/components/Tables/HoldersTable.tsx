...
import { ArrowRightIcon, Pagination, LoadTable } from "@ui";

import { HoldersColumnSort } from "./HoldersColumnSort";
...
const HoldersTable = (): JSX.Element => {
