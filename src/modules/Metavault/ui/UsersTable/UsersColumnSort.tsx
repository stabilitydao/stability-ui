...
const styles: Record<string, string> = {
  User: "sticky left-0 z-10 lg:relative w-[150px] md:w-1/4 bg-[#151618] lg:bg-transparent",
  Deposit: "w-[100px] md:w-1/4 justify-end",
  Earned: "w-[100px] md:w-1/4 justify-end",
  Points: "w-[100px] md:w-1/4 justify-end",
};
