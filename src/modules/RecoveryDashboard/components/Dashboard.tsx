...
export function DashboardCard({ card, averageBurnRate, totalBurnPercent }: DashboardCardProps) {
  return (
...
export function DashboardGrid({ cards, averageBurnRate, totalBurnPercent }: DashboardGridProps) {
  return (
